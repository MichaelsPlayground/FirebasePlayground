...
public class ListMessagesFirestoreActivity extends AppCompatActivity {
    ...
    static final String TAG = "ListMessagesFirestore";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_messages_firestore);

        signedInUser = findViewById(R.id.etListMessagesFirestoreSignedInUser);
        receiveUser = findViewById(R.id.etListMessagesReceiveUser);
        progressBar = findViewById(R.id.pbListMessagesFirestore);

        userListView = findViewById(R.id.lvListMessagesFirestore);
        ...
        Button listMessages = findViewById(R.id.btnListMessagesFirestoreRun);
        listMessages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(ListMessagesFirestoreActivity.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        Button selectRecipient = findViewById(R.id.btnListMessagesFirestoreSelectRecipient);
        selectRecipient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ListMessagesFirestoreActivity.this, SelectUserDatabaseActivity.class);
        ...
        Button backToMain = findViewById(R.id.btnListMessagesFirestoreToMain);
        backToMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ListMessagesFirestoreActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
