 ...
 * source: https://github.com/firebase/quickstart-android/tree/master/storage
 */
public class MyUploadService extends MyBaseTaskService {
    ...
    private void uploadFromUri(final Uri fileUri) {
        ...
        Log.i(TAG, "uploadFromUri:dst:" + photoRef.getPath());
        photoRef.putFile(fileUri).
                ...
                .continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                        ...
                        Log.i(TAG, "uploadFromUri: upload success");
                ...
                .addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(@NonNull Uri downloadUri) {
                        // Upload succeeded
                        Log.i(TAG, "uploadFromUri: getDownloadUri success");
