...
public class ChatMessageDatabaseActivity extends AppCompatActivity {
            ...
            public void onEvent(@Nullable QuerySnapshot snapshot, @Nullable FirebaseFirestoreException error) {
                ...
                if (snapshot != null) {
                    ...
                    if (!snapshot.isEmpty()) {
                        ...
                        // if the snapshot is empty we are displaying a toast message.
                        Toast.makeText(ChatMessageDatabaseActivity.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                    }
                } else {
