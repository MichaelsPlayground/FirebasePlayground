...
public class SignInEmailPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eMail = findViewById(R.id.etSignInEmailPasswordEmail);
        password = findViewById(R.id.etSignInEmailPasswordPassword);
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SignInEmailPasswordActivity.this, SignUpEmailPasswordActivity.class);
